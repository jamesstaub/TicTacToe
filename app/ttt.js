...
TicTacToe.checkPickAgainstPairsArray = function(choiceval){
  ...
  console.log("arrays? " + thisMagicPairsArray + " - " + thisChosenValueArray);
  if(thisMagicPairsArray.length > 0){
    thisMagicPairsArray.forEach(function(mNumber){
      if(mNumber + choiceval === 12){
        ...
        createSumsOfPairs(choiceval, thisChosenValueArray, thisMagicPairsArray);
        addPickToArray(choiceval, thisChosenValueArray);
        console.log("well?");
        return false;
      }
    });
